...
Retrofit an "Move Tab to Profile" feature for Gecko-based browsers via a WebExtension paired with a Native Messaging Host (NMH). Design priority: **Security First** – no additional attack surface on the system.
